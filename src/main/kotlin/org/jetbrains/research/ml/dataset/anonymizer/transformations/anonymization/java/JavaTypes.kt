...
object JavaTypes : JvmTypes() {
    ...
    override fun isStaticFunction(element: PsiElement): Boolean = element is PsiMethod && isStatic(element)
    override fun isNonStaticFunction(element: PsiElement): Boolean = element is PsiMethod && !isStatic(element)
    ...
    override fun isStatic(element: PsiMember): Boolean = element.hasModifier("static")
